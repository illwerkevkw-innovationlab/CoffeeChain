...
namespace CoffeeChain.App
{
    public partial class App : Application, INotifyPropertyChanged
    {
        ...
        private static string AccountAddress = "0x54585691af6387f8a23eae6f280d2b6a4c9dc586";
        private static string PrivateKey = "ba303798ccf5db5b474d133397fe45fd665a46358720163dfd48bc73d219adc6";
        ...
        {
            System.Console.WriteLine($"Starting Bootstrapping of Services: {System.DateTime.Now}");
            //var account = Account.LoadFromKeyStore(KeyFile, PassPhrase);
            //var account = new ManagedAccount(AccountAddress, PassPhrase);
            var account = new Account(PrivateKey, 242);
            System.Console.WriteLine($"Finished loading of account: {System.DateTime.Now}");
            var web3 = new Nethereum.Web3.Web3(account, ServerIpAddress);
            System.Console.WriteLine($"Finished loading of web3: {System.DateTime.Now}");
            var service = new CoffeeEconomyService(account, web3, ContractAddress);
            System.Console.WriteLine($"Finished loading of service: {System.DateTime.Now}");
